...
def init_test_schema(request, db_parameters) -> None:
    """Initializes and Deinitializes the test schema. This is automatically called per test
    session. """
    ret = db_parameters
...
def negative_conn_cnx() -> Callable[..., Generator["SnowflakeConnection", None, None]]:
    """Use this if an incident is expected and we don't want GS to create a dump file about the
    incident. """
    return negative_db
