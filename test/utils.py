...
class TestData:
    ...
    def test_data1(cls, session: 'Session') -> DataFrame:
        return session.createDataFrame([cls.Data(1, True, "a"), cls.Data(2, False, "b")])

    @classmethod
    def test_data2(cls, session: 'Session') -> DataFrame:
        return session.createDataFrame([cls.Data2(1, 1), cls.Data2(1, 2), cls.Data2(2, 1),
                                        cls.Data2(2, 2), cls.Data2(3, 1), cls.Data2(3, 2)])
