...
# Try to save the original types for snowflake _vendored urllib3
try:
...
class CassettePatcherBuilder:
    ...
    def _boto3(self):
        ...
        try:
            ...
            try:
                # botocore using _vendored requests
                import botocore.vendored.requests.packages.urllib3.connectionpool as cpool
            except ImportError:  # pragma: no cover
                pass
            else:
    ...
    # patch snowflake _vendored urllib3
    def _snowflake_urllib3(self):
        try:
            import snowflake.connector.vendored.urllib3.connectionpool as snowflake_cpool
        except ImportError:  # pragma: no cover
            return ()
...
def reset_patchers():
    ...
    try:
        ...
        if requests.__build__ < 0x021603:
            ...
            raise ImportError("Skip requests not _vendored anymore")
    except ImportError:  # pragma: no cover
        pass
    else:
    ...
    try:
        ...
        try:
            # unpatch botocore with _vendored requests
            import botocore.vendored.requests.packages.urllib3.connectionpool as cpool
        except ImportError:  # pragma: no cover
            pass
        else:
