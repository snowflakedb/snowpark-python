...
def register_series_not_implemented():
    def decorator(base_method: Any):
        ...
        register_series_accessor_with_telemetry(name)(func)
        return func
...
@register_series_accessor_with_telemetry("hist")
def hist(
    self,
    by=None,
    ax=None,
...
@register_series_accessor_with_telemetry("items")
def items(self):
...
@register_series_accessor_with_telemetry("__init__")
def __init__(
    self,
    data=None,
    index=None,
...
@register_series_accessor_with_telemetry("memory_usage")
...
@register_series_accessor_with_telemetry("isin")
...
@register_series_accessor_with_telemetry("plot")
@property
def plot(
    self,
    kind="line",
...
@register_series_accessor_with_telemetry("sub")
...
register_series_accessor_with_telemetry("subtract")(sub)


@register_series_accessor_with_telemetry("rsub")
...
@register_series_accessor_with_telemetry("mul")
...
register_series_accessor_with_telemetry("multiply")(mul)


@register_series_accessor_with_telemetry("rmul")
...
@register_series_accessor_with_telemetry("truediv")
...
register_series_accessor_with_telemetry("div")(truediv)
register_series_accessor_with_telemetry("divide")(truediv)


@register_series_accessor_with_telemetry("rtruediv")
def rtruediv(
...
register_series_accessor_with_telemetry("rdiv")(rtruediv)


@register_series_accessor_with_telemetry("floordiv")
def floordiv(
    self, other, level=None, fill_value=None, axis=0
):  # noqa: PR01, RT01, D200
    """
...
@register_series_accessor_with_telemetry("rfloordiv")
def rfloordiv(
    self, other, level=None, fill_value=None, axis=0
):  # noqa: PR01, RT01, D200
    """
...
@register_series_accessor_with_telemetry("mod")
...
@register_series_accessor_with_telemetry("rmod")
...
@register_series_accessor_with_telemetry("pow")
...
@register_series_accessor_with_telemetry("rpow")
...
@register_series_accessor_with_telemetry("__add__")
...
# Modin defaults to pandas for binary operators against native pandas/list objects.
@register_series_accessor_with_telemetry("__radd__")
...
# Modin defaults to pandas for binary operators against native pandas/list objects.
@register_series_accessor_with_telemetry("__and__")
...
# Modin defaults to pandas for binary operators against native pandas/list objects.
@register_series_accessor_with_telemetry("__rand__")
...
# Modin defaults to pandas for binary operators against native pandas/list objects.
@register_series_accessor_with_telemetry("__divmod__")
...
# Modin defaults to pandas for binary operators against native pandas/list objects.
@register_series_accessor_with_telemetry("__rdivmod__")
...
# Modin defaults to pandas for binary operators against native pandas/list objects.
@register_series_accessor_with_telemetry("__floordiv__")
...
# Modin defaults to pandas for binary operators against native pandas/list objects.
@register_series_accessor_with_telemetry("__rfloordiv__")
...
# Modin defaults to pandas for binary operators against native pandas/list objects.
@register_series_accessor_with_telemetry("__mod__")
...
# Modin defaults to pandas for binary operators against native pandas/list objects.
@register_series_accessor_with_telemetry("__rmod__")
...
# Modin defaults to pandas for binary operators against native pandas/list objects.
@register_series_accessor_with_telemetry("__mul__")
...
# Modin defaults to pandas for binary operators against native pandas/list objects.
@register_series_accessor_with_telemetry("__rmul__")
...
# Modin defaults to pandas for binary operators against native pandas/list objects.
@register_series_accessor_with_telemetry("__or__")
...
# Modin defaults to pandas for binary operators against native pandas/list objects.
@register_series_accessor_with_telemetry("__ror__")
...
# Modin defaults to pandas for binary operators against native pandas/list objects.
@register_series_accessor_with_telemetry("__xor__")
...
# Modin defaults to pandas for binary operators against native pandas/list objects.
@register_series_accessor_with_telemetry("__rxor__")
...
# Modin defaults to pandas for binary operators against native pandas/list objects.
@register_series_accessor_with_telemetry("__pow__")
...
# Modin defaults to pandas for binary operators against native pandas/list objects.
@register_series_accessor_with_telemetry("__rpow__")
...
# Modin defaults to pandas for binary operators against native pandas/list objects.
@register_series_accessor_with_telemetry("__sub__")
def __sub__(self, right):
    return self.sub(right)


# Modin defaults to pandas for binary operators against native pandas/list objects.
@register_series_accessor_with_telemetry("__rsub__")
def __rsub__(self, left):
    return self.rsub(left)


# Modin defaults to pandas for binary operators against native pandas/list objects.
@register_series_accessor_with_telemetry("__truediv__")
def __truediv__(self, right):
    return self.truediv(right)


# Modin defaults to pandas for binary operators against native pandas/list objects.
@register_series_accessor_with_telemetry("__rtruediv__")
def __rtruediv__(self, left):
    return self.rtruediv(left)


register_series_accessor_with_telemetry("__iadd__")(__add__)
# In upstream modin, imul is typo'd to be __add__ instead of __mul__
register_series_accessor_with_telemetry("__imul__")(__mul__)
register_series_accessor_with_telemetry("__ipow__")(__pow__)
register_series_accessor_with_telemetry("__isub__")(__sub__)
register_series_accessor_with_telemetry("__itruediv__")(__truediv__)


# Upstream Modin does validation on func that Snowpark pandas does not.
@register_series_accessor_with_telemetry("aggregate")
def aggregate(
...
register_series_accessor_with_telemetry("agg")(aggregate)


# Upstream Modin does a significant amount of frontend manipulation and may default to pandas.
@register_series_accessor_with_telemetry("apply")
def apply(
    self,
    func: AggFuncType,
...
@register_series_accessor_with_telemetry("map")
def map(
    self,
...
register_series_accessor_with_telemetry("attrs")(property(_get_attrs, _set_attrs))


# Snowpark pandas does different validation than upstream Modin.
@register_series_accessor_with_telemetry("argmax")
...
# Snowpark pandas does different validation than upstream Modin.
@register_series_accessor_with_telemetry("argmin")
...
@register_series_accessor_with_telemetry("case_when")
...
@register_series_accessor_with_telemetry("compare")
def compare(
    self,
    other: Series,
...
@register_series_accessor_with_telemetry("dropna")
def dropna(
    self,
    *,
    axis: Axis = 0,
...
@register_series_accessor_with_telemetry("duplicated")
...
@register_series_accessor_with_telemetry("sum")
def sum(
    self,
    axis: Axis | None = None,
    skipna: bool = True,
...
@register_series_accessor_with_telemetry("std")
def std(
    self,
    axis: Axis | None = None,
    skipna: bool = True,
...
# Snowpark pandas handles kwargs differently than modin.
@register_series_accessor_with_telemetry("var")
def var(
    self,
    axis: Axis | None = None,
    skipna: bool = True,
...
@register_series_accessor_with_telemetry("cat")
@property
...
@register_series_accessor_with_telemetry("dt")
@property
...
@register_series_accessor_with_telemetry("str")
@property
...
register_series_accessor_with_telemetry("name")(property(Series._get_name, _set_name))


# Modin uses len(self.index) instead of len(self), which may incur an extra query.
@register_series_accessor_with_telemetry("empty")
@property
def empty(self) -> bool:
    return len(self) == 0
...
@register_series_accessor_with_telemetry("fillna")
def fillna(
    self,
...
@register_series_accessor_with_telemetry("groupby")
def groupby(
    self,
    by=None,
    axis: Axis = 0,
...
@register_series_accessor_with_telemetry("info")
def info(
    self,
...
@register_series_accessor_with_telemetry("_qcut")
def _qcut(
    self,
    q: int | ListLike,
    retbins: bool = False,
...
@register_series_accessor_with_telemetry("replace")
def replace(
    self,
    to_replace=None,
    value=no_default,
...
@register_series_accessor_with_telemetry("reset_index")
def reset_index(
    self,
    level=None,
    drop=False,
...
@register_series_accessor_with_telemetry("set_axis")
def set_axis(
    self,
    labels: IndexLabel,
    *,
...
@register_series_accessor_with_telemetry("rename")
def rename(
    self,
...
# (see SNOW-1019312).
@register_series_accessor_with_telemetry("unique")
...
@register_series_accessor_with_telemetry("unstack")
def unstack(
    self,
...
@register_series_accessor_with_telemetry("sort_values")
def sort_values(
    self,
    axis: Axis = 0,
...
@register_series_accessor_with_telemetry("where")
def where(
    self,
...
@register_series_accessor_with_telemetry("value_counts")
def value_counts(
    self,
...
@register_series_accessor_with_telemetry("shift")
def shift(
    self,
...
@register_series_accessor_with_telemetry("squeeze")
...
@register_series_accessor_with_telemetry("_prepare_inter_op")
...
# Don't put telemetry on this method since it's an internal helper.
@register_series_accessor_with_telemetry("_to_datetime")
...
@register_series_accessor_with_telemetry("to_list")
@materialization_warning
...
register_series_accessor_with_telemetry("tolist")(to_list)


@materialization_warning
@register_series_accessor_with_telemetry("to_dict")
...
@materialization_warning
@register_series_accessor_with_telemetry("to_numpy")
def to_numpy(
    self,
...
@register_series_accessor_with_telemetry("_to_pandas")
@materialization_warning
def _to_pandas(
    self,
    *,
...
@register_series_accessor_with_telemetry("__setitem__")
...
@register_series_accessor_with_telemetry("__repr__")
def __repr__(self):
    """
