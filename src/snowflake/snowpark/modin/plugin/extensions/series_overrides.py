...
# 4. Performs operations on a native pandas Index object that are nontrivial for Snowpark pandas to manage.
    ...
    def aggregate(
        ...
        result = super().aggregate(func, axis, *args, **kwargs)
        return result
    ...
    name = property(pd.SeriesImpl._get_name, _set_name)
