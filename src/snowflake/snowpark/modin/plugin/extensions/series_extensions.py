...
import pandas
from modin.pandas.api.extensions import register_series_extension
...
from .base_overrides import BaseSnowparkPandasDataset
from .series_overrides import SeriesOverrides

class SnowparkPandasSeries(SeriesOverrides, BaseSnowparkPandasDataset, pd.SeriesImpl):
    def to_snowflake(
        self,
...
register_series_extension("Snowflake", "Snowflake", SnowparkPandasSeries)