...
from modin.pandas.api.extensions import register_dataframe_extension
from .base_overrides import BaseSnowparkPandasDataset
from .dataframe_overrides import DataFrameOverrides
from snowflake.snowpark.modin.plugin.utils.warning_message import (
    materialization_warning,
)
import functools

class SnowparkPandasDataFrame(DataFrameOverrides, BaseSnowparkPandasDataset, pd.DataFrameImpl):
...
register_dataframe_extension("Snowflake", "Snowflake", SnowparkPandasDataFrame)