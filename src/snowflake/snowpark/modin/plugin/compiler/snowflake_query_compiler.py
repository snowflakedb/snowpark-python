...
class SnowflakeQueryCompiler(BaseQueryCompiler):
    ...
    def move_to_cost(
        ...
        if NativeQueryCompiler is other_qc_cls:
            return SnowflakeQueryCompiler._bin_to_cost_limits(
                row_cost_ratio * QCCoercionCost.COST_IMPOSSIBLE
            )
        return None
    ...
    def stay_cost(
        ...
        if row_cost_ratio <= 1.0 and operation == "apply":
            return QCCoercionCost.COST_IMPOSSIBLE
    ...
    def move_to_me_cost(
        ...
        if cost_ratio > 1.0:
            return SnowflakeQueryCompiler._bin_to_cost_limits(
                cost_ratio * QCCoercionCost.COST_IMPOSSIBLE
            )
        else:
    ...
    def index(
        ...
        "snowflake.snowpark.modin.plugin.extensions.index.Index", native_pd.MultiIndex
    ]:
        """
    ...
    def groupby_groups(
        ...
        axis: int,
        groupby_kwargs: dict[str, Any],
    ) -> PrettyDict[Hashable, "snowflake.snowpark.modin.plugin.extensions.index.Index"]:
        """
