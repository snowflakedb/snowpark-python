...
cp $SRC_ROOT/Snowpark/proto/ast_pb2.py $SCRIPT_DIR/generated/
cp $SRC_ROOT/Snowpark/proto/scalapb/scalapb_pb2.py $SCRIPT_DIR/generated/

# Step 3: Fix up scalapb file import in ast_pb2.py
awk '{gsub("from scalapb import scalapb_pb2 as scalapb_dot_scalapb__pb2","import snowflake.snowpark._internal.proto.scalapb_pb2 as scalapb_dot_scalapb__pb2")}1' $SCRIPT_DIR/generated/ast_pb2.py > $SCRIPT_DIR/generated/ast_pb2.patched.py \
&& mv $SCRIPT_DIR/generated/ast_pb2.patched.py $SCRIPT_DIR/generated/ast_pb2.py
