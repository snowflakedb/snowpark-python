...
from snowflake.snowpark._internal.lazy_import_utils import lazy_import, get_installed_pandas, get_numpy, get_pandas, \
    get_snowpark_types
...
def python_type_str_to_object(
    ...
    elif tp_str in ["Series", "pd.Series"] and get_installed_pandas():
...
def python_type_to_snow_type(
    ...
    if get_installed_pandas():
        ...
        if pandas_types:
            PandasDataFrame, PandasDataFrameType, PandasSeries, PandasSeriesType = pandas_types
