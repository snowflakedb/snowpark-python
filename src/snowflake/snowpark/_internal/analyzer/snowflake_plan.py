...
class SnowflakePlanBuilder:
    ...
    def from_table_function(self, func: str, source_plan: Optional[LogicalPlan]) -> SnowflakePlan:
        if isinstance(source_plan.table_function, GeneratorTableFunction):
            return self.query(table_function_statement(func, source_plan.table_function.operators), source_plan)
