...
class SnowflakePlan(LogicalPlan):
    ...
    def set_last_query_line_intervals(self) -> None:
        ...
        final_sql = remove_comments(
            last_query.sql, child_uuids, self.session._new_line_token
        )
...
class SnowflakePlanBuilder:
    ...
    def build(
        ...
        clean_sql = formatted_sql.replace(self.session._new_line_token, "")
    ...
    def with_query_block(
        ...
        clean_new_query = formatted_new_query.replace(self.session._new_line_token, "")
