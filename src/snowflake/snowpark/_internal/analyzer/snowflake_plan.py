                ...
                try:
                    ...
                    if "unexpected 'as'" in e.msg.lower():
                        ...
                        if col in remapped:
                            ...
                            # Only Selectable and SnowflakePlan expose quoted identifiers; other nodes
                            # from children_plan_nodes (e.g. Sort) are skipped. This could be improved
                            # by recursively traversing LogicalPlan.children to reach inner plans if needed.
                            quoted_identifiers: List[str] = []
                            for child in children:
                                for node in child.children_plan_nodes:
