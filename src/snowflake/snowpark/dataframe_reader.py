...
class DataFrameReader:
    ...
    Provides methods to load data in various supported formats from a Snowflake stage to a DataFrame.
      ...
      To use this object:
       ...
       1. Specify the schema of the data that you plan to load by constructing a StructType
       ...
       1. Specify the format of the data by calling the method named after the format (e.g. [[csv]],
          ...
          specified format.
       1. Call a [[DataFrame]] method that performs an action (e.g. [[DataFrame.collect]]) to load the
          data from the file.
    ...
    def table(self, name: str) -> DataFrame:
        ...
        For the {@code name} argument, you can specify an unqualified name (if the table
        ...
        performs an action (e.g. [[DataFrame.collect]], [[DataFrame.count]], etc.)."""
