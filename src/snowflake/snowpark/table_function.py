...
def _create_generator_function_expression(*operators: ColumnOrName, **named_args: ColumnOrName):
    args = {arg_name: _to_col_if_str(arg, "generator function")._expression for arg_name, arg in named_args.items()}
    operators = [_to_col_if_str(operator, "generator function")._expression for operator in operators]
