...
class TableFunctionCall:
    ...
    def table_alias(self, alias: str) -> "TableFunctionCall":
        """This is used to set alias of table when this table function call is joined with a different
        table. It is useful in cases when there is an overlap between output columns of table function
        and the table

        Args:
            alias: alias for the table generated by the table function call.
        """
...
def _create_table_function_expression(
    ...
    **named_args: ColumnOrName,
    ...
    table_function_expression.table_alias = table_alias
