...
from snowflake.snowpark.functions import (
    ...
    stddev,
    to_char,
    ai_complete as ai_complete_function,
)
    ...
    def ai_complete(
        ...
        *,
        ...
        Examples::
            ...
            ... )
            >>> # Use ai_complete with image files
            >>> result_df = df.ai_complete(
        ...
        if not model:
            raise ValueError("model must be specified for ai_complete")
        ...
        return self.with_column(output_column_name, result_col, _emit_ast=False)
