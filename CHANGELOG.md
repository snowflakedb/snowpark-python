...
- Added lazy index constructor and support for `len`, `shape`, `size`, `empty`, `to_pandas()`, `names`, `name`, `rename` and `set_names`. For `df.index`, Snowpark pandas creates a lazy index object. 
