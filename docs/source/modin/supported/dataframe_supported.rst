...
+-----------------------------+---------------------------------+----------------------------------------------------+
| ``attrs``                   | P                               | ``Y`` for most DataFrame and DataFrameGroupBy      |
|                             |                                 | methods. Snowpark pandas does not preserve         |
|                             |                                 | ``attrs`` across other operations that native      |
|                             |                                 | pandas does, such as indexing, resample, and       |
|                             |                                 | window functions.                                  |
+-----------------------------+---------------------------------+----------------------------------------------------+
| ``axes``                    | Y                               |                                                    |
+-----------------------------+---------------------------------+----------------------------------------------------+
