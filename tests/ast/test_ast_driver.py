...
def test_ast(session, tables, test_case):
    ...
    test_case_filename = test_case.filename.replace(".", "_")
    actual, base64_str = run_test(session, tables, test_case_filename, test_case.source)
    ...
    if pytest.update_expectations:
        ...
        try:
            ...
            actual_message = base64_lines_to_request(stripped_base64_str)
