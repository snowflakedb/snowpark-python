...
def test_groupby_axis_1(group_name):
    ...
    msg = "GroupBy.max is not implemented for the given parameter combination"
...
def test_groupby_axis_1_mi(group_name):
    ...
    msg = "GroupBy.sum is not implemented for the given parameter combination"
    with pytest.raises(NotImplementedError, match=msg):
        snow_df_mi.groupby(axis=1, by=group_name).sum()

    msg = "GroupBy.min is not implemented for the given parameter combination"
    with pytest.raises(NotImplementedError, match=msg):
...
def test_std_var_ddof_unsupported(basic_snowpark_pandas_df, grp_agg, agg_name, by):
    ...
    msg = f"GroupBy.{agg_name} is not implemented for the given parameter combination"
    with pytest.raises(NotImplementedError, match=msg):
...
def test_groupby_ngroups_axis_1():
    ...
    msg = "GroupBy.ngroups is not implemented for the given parameter combination"
    with pytest.raises(NotImplementedError, match=msg):
