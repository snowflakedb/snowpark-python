...
def test_where_with_zero_other_mixed_types_SNOW_1372268():
     ...
     assert_snowpark_pandas_equals_to_pandas_without_dtypecheck(df_result, native_df_result.astype('str'))
...
def test_where_with_zero_other_SNOW_1372268():
     ...
     assert_snowpark_pandas_equals_to_pandas_without_dtypecheck(df_result, native_df_result)