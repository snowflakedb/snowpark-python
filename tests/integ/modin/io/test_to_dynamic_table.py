...
class TestDataFrame:
    ...
    def test_to_dynamic_table_no_enforce_ordering(self, session) -> None:
        try:
            # create table
            table_name = Utils.random_table_name()
            session.create_dataframe(
    ...
    @sql_count_checker(query_count=6)
    def test_to_dynamic_table_index(self, session, index, index_labels):
        try:
            # create table
            table_name = Utils.random_table_name()
            session.create_dataframe(
    ...
    @sql_count_checker(query_count=6)
    def test_to_dynamic_table_multiindex(self, session):
        try:
            # create table
            table_name = Utils.random_table_name()
            session.create_dataframe(
