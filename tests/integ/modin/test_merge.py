...
# actual counts are 2, 2 but multithreaded_run() runs the test 5 times
# so we increase the counts to 10, 10
@sql_count_checker(query_count=10, join_count=10, high_count_expected=True, high_count_reason="multithreaded_run")
@multithreaded_run()
