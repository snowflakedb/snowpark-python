...
postgres_schema = StructType(
    [
        ...
        StructField("BIT_COL", StringType(MAX_STRING_SIZE), nullable=True),
        StructField("BIT_VARYING_COL", StringType(MAX_STRING_SIZE), nullable=True),
        StructField("BOOLEAN_COL", BooleanType(), nullable=True),
        StructField("BOX_COL", StringType(MAX_STRING_SIZE), nullable=True),
        StructField("BYTEA_COL", BinaryType(), nullable=True),
        StructField("CHAR_COL", StringType(MAX_STRING_SIZE), nullable=True),
        StructField("VARCHAR_COL", StringType(MAX_STRING_SIZE), nullable=True),
        StructField("CIDR_COL", StringType(MAX_STRING_SIZE), nullable=True),
        StructField("CIRCLE_COL", StringType(MAX_STRING_SIZE), nullable=True),
        StructField("DATE_COL", DateType(), nullable=True),
        StructField("DOUBLE_PRECISION_COL", DoubleType(), nullable=True),
        StructField("INET_COL", StringType(MAX_STRING_SIZE), nullable=True),
        StructField("INTEGER_COL", LongType(), nullable=True),
        StructField("INTERVAL_COL", StringType(MAX_STRING_SIZE), nullable=True),
        StructField("JSON_COL", VariantType(), nullable=True),
        StructField("JSONB_COL", VariantType(), nullable=True),
        StructField("LINE_COL", StringType(MAX_STRING_SIZE), nullable=True),
        StructField("LSEG_COL", StringType(MAX_STRING_SIZE), nullable=True),
        StructField("MACADDR_COL", StringType(MAX_STRING_SIZE), nullable=True),
        StructField("MACADDR8_COL", StringType(MAX_STRING_SIZE), nullable=True),
        StructField("MONEY_COL", VariantType(), nullable=True),
        StructField("NUMERIC_COL", DecimalType(10, 2), nullable=True),
        StructField("PATH_COL", StringType(MAX_STRING_SIZE), nullable=True),
        StructField("PG_LSN_COL", StringType(MAX_STRING_SIZE), nullable=True),
        StructField("PG_SNAPSHOT_COL", StringType(MAX_STRING_SIZE), nullable=True),
        StructField("POINT_COL", StringType(MAX_STRING_SIZE), nullable=True),
        StructField("POLYGON_COL", StringType(MAX_STRING_SIZE), nullable=True),
        ...
        StructField("TEXT_COL", StringType(MAX_STRING_SIZE), nullable=True),
        ...
        StructField("TSQUERY_COL", StringType(MAX_STRING_SIZE), nullable=True),
        StructField("TSVECTOR_COL", StringType(MAX_STRING_SIZE), nullable=True),
        StructField("TXID_SNAPSHOT_COL", StringType(MAX_STRING_SIZE), nullable=True),
        StructField("UUID_COL", StringType(MAX_STRING_SIZE), nullable=True),
        StructField("XML_COL", StringType(MAX_STRING_SIZE), nullable=True),
    ]
)
