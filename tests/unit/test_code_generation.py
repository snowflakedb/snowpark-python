...
def test_import_module():
    ...
    from tests.unit.module_holder import Child, Parent, module_method, module_var

    def udf_import_class(a, b):
        return Parent().bar() + Child().bar() + datetime.now().year

    print(generate_source_code(udf_import_class))
...
# The following comment contains the UDF source code generated by snowpark-python for explanatory purposes.
# from datetime import datetime
# from tests.unit.module_holder import Child, Parent
# def udf_import_class(a, b):
#     return Parent().bar() + Child().bar() + datetime.now().year
#
...
"""
    ...
    assert (
        ...
        == """\
# The following comment contains the UDF source code generated by snowpark-python for explanatory purposes.
# from tests.unit.module_holder import module_method
# def udf_import_method(a, b, c):
#     return module_method(a, b, c)
#
...
"""
    ...
    assert (
        ...
        == """\
# The following comment contains the UDF source code generated by snowpark-python for explanatory purposes.
# from tests.unit.module_holder import Child, Parent, module_method
