...
from snowflake.snowpark.modin.plugin.compiler.snowflake_query_compiler import InternalFrame
from snowflake.snowpark.modin.plugin._internal.frame import OrderedDataFrame, OrderingColumn
from snowflake.snowpark.modin.plugin._internal.join_utils import _create_internal_frame_with_join_or_align_result, JoinKeyCoalesceConfig, InheritJoinIndex
...
def mock_internal_frame(
    ...
    ordered_dataframe.projected_column_snowflake_quoted_identifiers = data_column_snowflake_quoted_identifiers + index_column_snowflake_quoted_identifiers
    ordered_dataframe.ordering_columns = [OrderingColumn(col) for col in ordered_dataframe.projected_column_snowflake_quoted_identifiers]
...
def test_create_internal_frame_with_result_using_invalid_methods(
    ...
    result_ordered_frame.projected_column_snowflake_quoted_identifiers = ['"I1"', '"A1"', '"B1"', '"I2"', '"A2"', '"B2"']
